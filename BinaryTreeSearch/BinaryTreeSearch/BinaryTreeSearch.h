...
public:
    ...
    static BinaryTreeSearch createOptimalTree(std::vector<int> d, std::vector<int> &p, std::vector<int> &q);
    static Node* createOptimalTree(std::vector<int> &d,std:: vector<std::vector<int>> &matrix,int i , int j);
